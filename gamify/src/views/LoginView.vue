...
const handleLogin = async () => {
  ...
  if (!password.value) {
    errorMsg.value = 'Por favor, insira a sua senha.'
    return
  }
  ...
  try {
    ...
    errorMsg.value = err.message || 'Erro ao iniciar sessão. Verifique as credenciais.'
  }
}
</script>
  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <form @submit.prevent="handleLogin" class="auth-form">
        ...
        <div class="form-options-row">
          <label class="checkbox-container">
            ...
            <span class="checkbox-label">Manter a minha sessão iniciada</span>
          </label>
      ...
      <footer class="auth-footer">
        ...
        <router-link to="/register" class="auth-footer-link">Registe-se</router-link>
      </footer>
    </div>
  </div>
</template>
